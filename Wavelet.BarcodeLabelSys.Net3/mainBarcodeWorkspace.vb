...
Imports Wavelet.BarcodeLabelSys.Net3.EMPCoreService
...
Public Class mainBarcodeWorkspace
    ...
    Dim CoreClient As New EMPCoreService.EMPCoreService
    ...
    Sub DynamicSearchbyItemCode()
        Try
            ...
            If txtGRNCode.Text <> "" Then
                ...
                If (Not itmObj Is Nothing AndAlso itmObj.code.length > 0) Then
                    Dim bItem As BarcodeItem = getBarcodeItem(itmObj)
                    AddItemToList(bItem)
            ...
            If txtGRNCode.Text <> "" Then
                ...
                If itmObjArray.Length > 0 Then
                    For cntlist = 0 To itmObjArray.Length - 1
                        ...
                        If (Not itmObjArray(cntlist) Is Nothing) Then
                ...
                If (Not itmObjArray(0) Is Nothing) Then
                    lbStatus.Text = "Status :Item code Found [" & txtGRNCode.Text & "]"
                Else
                    lbStatus.Text = "Status :Cannot Find Item code from server."
                End If
...
#Region "EMP CoreService"
    ...
    Protected Function wsGetMethod(ByVal methodname As String, ByVal argValue As String) As Object
        ...
        Dim ws = New EMPCoreService.EMPCoreService
        ws.Url = WebServicesAddress.Trim + "?wsdl"

        Select Case methodname

            Case "getGoodsReceivedNote"

                Return ws.getGoodsReceivedNote(argValue)

            Case "getItemByCode"

                Return ws.getItemByCode(argValue)

            Case "getItemFuzzySearch"

                Return ws.getItemFuzzySearch(argValue)

            Case "getItemByEANCode"

                Return ws.getItemByEANCode(argValue)

            Case "getItem"

                Return ws.getItem(argValue)

            Case "getInternalStockTransfer"

                Return ws.getInternalStockTransfer(argValue)
    ...
    Protected Function wsGetMethod2(ByVal methodname As String, ByVal argValue As String) As Object
        Dim cntMethod As Integer = 0
